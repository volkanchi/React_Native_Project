...
export default function DriverMainScreen({ onLogout }: DriverMainScreenProps) {
  ...
  const handleStartTrip = async () => {
    ...
    try {
      ...
      subscribeToPassengerActivity(
        (passengerId) =>
          setActivePassengers((prev) => [...new Set([...prev, passengerId])]),
        (passengerId) =>
            ...
            <Marker
              ...
              pinColor={
                i < currentStopIndex
                  ...
                  : i === currentStopIndex
                    ? "#1E4ED8"
                    : "#22C55E" // Sıradaki durak değilse yeşil yansın ki şoför aktif yolcu olduğunu anlasın
              }
            />
          );
        })}
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.headerRow}>
            <View>
              ...
              <Text style={styles.title}>
                {routeData?.name || "Gerçek rota verisi bekleniyor"}
              </Text>
            </View>
          ...
          <View style={styles.summaryCard}>
            ...
            <View style={styles.summaryItem}>
              ...
              <Text style={styles.summaryValue}>
                {routeData?.vehicleModel || "API’den gelecek"}
              </Text>
            </View>
          </View>
          ...
          {!routeData && (
            <View style={styles.emptyStateBox}>
              <Text style={styles.emptyStateText}>
                Gerçek rota verisi API’den gelene kadar bu ekran bekleme modunda
                kalır.
              </Text>
            </View>
          )}
